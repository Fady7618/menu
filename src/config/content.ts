...
export const SOCIAL_LINKS = [
  ...
  { id: 'twitter', href: 'https://twitter.com', icon: 'Twitter', label: 'Twitter' },
] as const;

export const CONTACT_INFO = [
  { id: 'address', icon: 'MapPin', text: '123 Food Street, City', type: 'address' as const },
  { id: 'phone', icon: 'Phone', text: '+1 (555) 123-4567', type: 'phone' as const },
  { id: 'email', icon: 'Mail', text: 'info@delicious.com', type: 'email' as const },
] as const;
