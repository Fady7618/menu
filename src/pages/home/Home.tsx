...
const FEATURES = [
  { id: 'chefs',    icon: '👨‍🍳', title: 'Expert Chefs',      description: 'Our team of talented chefs brings years of culinary expertise' },
  { id: 'fresh',    icon: '🥗', title: 'Fresh Ingredients', description: 'We source only the finest and freshest local ingredients' },
  { id: 'quality',  icon: '⭐', title: 'Premium Quality',   description: 'Every dish is crafted with attention to detail and passion' },
  { id: 'delivery', icon: '🚚', title: 'Fast Delivery',     description: 'Quick and reliable delivery right to your doorstep' },
];
