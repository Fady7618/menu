    ...
    <section className="relative min-h-screen bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-400 pt-32 pb-16 px-8 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="text-white animate-fade-in-up">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6">
              Welcome to <span className="bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">Delicious</span>
            </h1>
      ...
      <style>{`
        ...
        .animate-fade-in-right {
          animation: fade-in-right 1s ease 0.3s backwards;
        }
        .animate-float {
